...
class MeanFieldControlRoutingGame(pyspiel.Game):
  ...
  def new_initial_state(self) -> "MeanFieldControlRoutingGameState":
    """Returns the state corresponding to the start of a game."""
    return MeanFieldControlRoutingGameState(self, self.time_step_length)
...
class MeanFieldControlRoutingGameState(pyspiel.State):
  ...
  def __init__(self, game: MeanFieldControlRoutingGame, time_step_length: float):
...
pyspiel.register_game(_GAME_TYPE, MeanFieldControlRoutingGame)
